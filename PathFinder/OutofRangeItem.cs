...
{
    public partial class OutofRangeItem : Form
    {
        ...
        public OutofRangeItem(RouteInfo routeInfo, vdControls.vdFramedControl vdFramedControl, bool OnlyDetectedItem = false, List<int> OutofRange= null)
        {
            InitializeComponent();
            ...
            if (OutofRange != null && OutofRange.Count >0)
            {
                ...
                this.Text = "OutofRangeItems";
                label1.Text = "There following items are instrument which are outside of the range.";
            } 
        }
        ...
        private void PlaceLowerRight(Form t)
        {
